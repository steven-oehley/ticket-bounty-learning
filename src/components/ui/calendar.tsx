...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        'bg-background group/calendar p-3 [--cell-radius:var(--radius-4xl)] [--cell-size:--spacing(8)] data-[slot=card-content]:bg-transparent data-[slot=popover-content]:bg-transparent',
